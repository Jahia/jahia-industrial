CKEDITOR.editorConfig = function (config) {
    ...
    config.stylesSet = 'B4:'+((typeof contextJsParameters != 'undefined') ? contextJsParameters.contextPath : '') + '/modules/jahia-industrial/javascript/ckeditor/stylesSet.js';
    config.contentsCss = [
        ((typeof contextJsParameters != 'undefined') ? contextJsParameters.contextPath : '') + '/modules/bootstrap4-core/css/bootstrap.min.css',
        ((typeof contextJsParameters != 'undefined') ? contextJsParameters.contextPath : '') + '/modules/jahia-industrial/css/style.css'
        // ((typeof contextJsParameters != 'undefined') ? contextJsParameters.contextPath : '') + '/modules/jahia-industrial/javascript/ckeditor/css/editor.css'
    ];
    config.templates_files = [
        ...
        ((typeof contextJsParameters != 'undefined') ? contextJsParameters.contextPath : '') + '/modules/jahia-industrial/javascript/ckeditor/templates.js'
    ];
